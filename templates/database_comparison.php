...
<body>
  <main>
    ...
    <?php elseif ($comparison === null): ?>
      <!-- Progress UI: Shown when a comparison is running or about to start -->
      <div id="progress-view">
        <h1>Database Comparison</h1>
        <p class="lead">Analyzing differences between your databases...</p>
        
        <div id="progress-container" class="card">
          <div class="progress-header">
            <h2 id="progress-status-text">Initializing...</h2>
          ...
          <div class="progress-log-container">
            ...
            <div id="progress-log" class="progress-log">
              <!-- Log entries will be injected here by progress.js -->
            </div>
          </div>
        </div>

        <div id="progress-error" class="alert deletion hidden">
          <h2 style="margin-top: 0;">Comparison Failed</h2>
          <p id="progress-error-message"></p>
          <div style="margin-top: 1.5rem;">
            <a href="index.php" class="btn">Try Again</a>
          </div>
        </div>
    ...
    <?php else: ?>
      <!-- Results UI: Shown when the comparison is complete -->
      <div id="results-container">
        ...
        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 2rem;">
          ...
          <a href="index.php" class="btn btn-outline">New Comparison</a>
        </div>
